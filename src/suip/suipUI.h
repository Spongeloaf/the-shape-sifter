...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        table_active_parts = new QTableWidget(tab_active_parts);
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        actionShutdown_server_and_exit->setText(QCoreApplication::translate("MainWindow", "Shutdown server and exit", nullptr));
        ...
        tabWidget->setTabText(tabWidget->indexOf(tab_active_parts), QCoreApplication::translate("MainWindow", "Active Parts", nullptr));
