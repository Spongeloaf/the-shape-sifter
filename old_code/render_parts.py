...
GEOMETRY_PARAMS="-Seams=1 -SeamWidth=25 -BoundingBoxesOnly-0 -Wireframe=0 -RemoveHiddenLines=0 -WireframeFog=0 -WireframeThickness=5 -BFC=0 -ShowHighlightLines=1 -EdgesOnly=0 -ConditionalHighlights=1 -ShowAllType5=0 -ShowType5ControlPoints=0 -PolygonOffset=1 -BlackHighlights=1 -EdgeThickness=5"
...
PERSPECTIVELG="-FOV=0.1 -DefaultZoom=0.85 -DefaultMatrix=0.476843,0,0.878989,0.484195,0.834601,-0.262671,-0.733605,0.550854,0.397974"

FILES="c:\labels\input_angle"
fOutputDir="c:\labels\output_angle\\"
...
for root, dirs, filenames in os.walk(FILES):
    ...
    for f in filenames:
        ...
        fName='"{0}\{1}"'.format(FILES, f)
        print('Input file name: ', fName)

        fOutName=fOutputDir+f[:-4]+'_angle.png'
